# $OpenBSD: Makefile,v 1.122 2020/11/19 16:06:06 semarie Exp $
...
BV-aarch64 =		1.49.0-20201231
BV-amd64 =		1.49.0-20201230
BV-i386 =		1.49.0-20201230
BV-sparc64 =		1.49.0-20201231
BV =			${BV-${MACHINE_ARCH}}
