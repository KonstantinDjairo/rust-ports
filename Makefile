# $OpenBSD: Makefile,v 1.112 2020/05/16 14:13:53 semarie Exp $
...
BV-aarch64 =		1.44.0-20200605
BV-amd64 =		1.44.0-20200602
BV-i386 =		1.44.0-20200602
BV-sparc64 =		1.44.0-20200602
BV =			${BV-${MACHINE_ARCH}}
